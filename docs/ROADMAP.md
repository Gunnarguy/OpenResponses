...
| **Audio Input**             | ✅ **Complete**      | Full audio recording, base64 encoding, and API integration with microphone permissions. |
...
| :----------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------- |
| **Audio Input**                      | ✅ **Complete** - Full audio recording capabilities implemented with `AudioRecordingService`, `AudioRecordingButton`, base64 encoding, and API integration. Threading and permission issues resolved. | - ✅ Added audio recording UI using `AVAudioRecorder` with `AudioRecordingButton` component.<br>- ✅ Encoded recordings to base64 in `ChatViewModel`.<br>- ✅ Updated `OpenAIService.buildInputMessages()` to include `input_audio` objects with proper format handling.<br>- ✅ Added microphone permission handling with iOS 17+ `AVAudioApplication` API.<br>- ✅ Fixed threading deadlocks and privacy violation crashes.<br>- ✅ Resolved button interaction and permission flow issues. | 0.8        |
...
| **gpt-image-1 & Streaming Previews** | ✅ **Complete** - Upgraded to `gpt-image-1` with streaming support. App now uses the latest model with enhanced capabilities.                                                                         | - ✅ Updated tool configuration to use `image_generation` with `model: gpt-image-1`.<br>- ✅ Removed streaming restrictions for image generation.<br>- ✅ Added streaming event handling for progressive image generation updates.<br>- ✅ Support for multi-turn editing by adding instructions to subsequent requests.                                                                                                                                                                      | 0.9        |
