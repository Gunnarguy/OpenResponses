> Historical July draft, preserved September 8, 2026. Its verification and delivery claims are not evidence for the completed September build. See the [current dossier](../README.md) and [validation ledger](../Validation.md).
